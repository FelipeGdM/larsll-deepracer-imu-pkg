...
In the original code, the node calibrates the IMU every time it's initialized. It isn't a good idea to do it in run time, a new parameter called `calibrate` was created, in order to control when the calibration is performed
